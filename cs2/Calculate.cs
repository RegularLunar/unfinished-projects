...
namespace CS2
{
    internal class Calculate
    {
        ...
        public static List<Vector2> ReadBones2D(List<Vector3> bones, float[] viewMatrix, Vector2 screenSize)
        {
            ...
            {
                Vector2 bone2d = Calculate.boxWorldToScreen(viewMatrix, bone, screenSize);
                bones2D.Add(bone2d);
            }
            return bones2D;
        }
        public static Vector2 boxWorldToScreen(float[] matrix, Vector3 pos, Vector2 windowSize)
        {
        ...
        {
            Vector2 screenCord = new Vector2();
            ...
            if (screenW > 0.001f)
            {
                ...
                float X = canX + (canX * screenX / screenW);
                float Y = canY - (canY * screenY / screenW);
